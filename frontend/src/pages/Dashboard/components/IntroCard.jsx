                    ...
                    <div className='rounded-lg cursor-pointer w-[80%]'>
                        <div className='flex items-center gap-5 rounded-lg text-md text-cyan-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray'>
                            <div className='capitalize'>
                                <p className='cursor-pointer text-3xl' onClick={handleNameClick(currentCompanyDetails.website_url)}>{currentCompanyDetails.name}</p>
                                <p className='text-sm mt-2 text-gray-400 min-h-min text-justify'>{currentCompanyDetails.short_description}</p>
                            </div>
                        </div>
                    </div>
                    <div className='w-[15%] '>
